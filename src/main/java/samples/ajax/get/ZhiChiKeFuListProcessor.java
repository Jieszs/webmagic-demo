 ...
 * @author qq3434569
 */
public class ZhiChiKeFuListProcessor implements PageProcessor {
    @Override
    ...
    public static void main(String[] args) {
        Spider.create(new ZhiChiKeFuListProcessor()).addUrl("https://www.sobot.com/basic/getUserList/4?pageNo=1&pageSize=15&queryContent=&queryType=5&userStatus=0").run();
    }
}
