...
import samples.provider.ApiProxyProvider;
 ...
 * 爬虫3-代理池ip
 *
 * 使用https://github.com/jhao104/proxy_pool 安装代理池
 * 由于限制ip只能使用一次，需要更换稳定代理池，才能通关
 *
 * @author qq3434569
 */
public class CrawlerBasic3 implements PageProcessor {
    ...
    public static void main(String[] args) {
        ...
        downloader.setProxyProvider(new ApiProxyProvider());
